  ...
  return (
    <main className="min-h-screen bg-white dark:bg-black text-black dark:text-white">
      <div className="pt-40 pb-20 px-6 max-w-[1440px] mx-auto">
        <div className="mb-20">
          <span className="text-purple-500 font-azeret text-sm uppercase tracking-widest border border-purple-500 px-3 py-1 rounded-full">
            Stage 03
          </span>
          ...
          <p className="font-azeret text-xl md:text-2xl max-w-3xl leading-relaxed text-neutral-600 dark:text-neutral-400">
            Market leader tidak diam. Mereka melakukan pivot, ekspansi, dan
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          <div>
            ...
            <ul className="flex flex-col gap-6">
              {[
                "Puas dengan posisi saat ini (Innovator's Dilemma)",
                "Lambat merespon perubahan tren teknologi",
                "Legacy system yang kaku dan sulit dikembangkan",
                "Takut mengambil risiko untuk model bisnis baru",
              ].map((item, i) => (
                <li
                  key={i}
